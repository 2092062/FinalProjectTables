...
public class TestDataActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        //retrofit
         create_cart(userName.getText().toString(),productId.getText().toString());
    ...
    //retrofit
    public void create_cart(String user_name, String product_id){

        CreateCart cart=new CreateCart(product_id,user_name);
        ...
        Call<CreateCart> call=JsonHolder.SendCart(cart);

        call.enqueue(new Callback<CreateCart>() {
            @Override
            public void onResponse(Call<CreateCart> call, Response<CreateCart> response) {
                ...
                CreateCart cart1= response.body();
            ...
            @Override
            public void onFailure(Call<CreateCart> call, Throwable t) {
